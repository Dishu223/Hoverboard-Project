...
export function CanvasBoard({ socket, isArtist, isPlaying, activeMutator }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', flex: 1 }}>
      {isArtist && isPlaying && (
        <div style={{ padding: '16px', background: 'var(--glass-bg)', borderRadius: '16px', marginBottom: '16px', display: 'flex', flexWrap: 'wrap', gap: '16px', border: '1px solid var(--color-primary)' }}>
