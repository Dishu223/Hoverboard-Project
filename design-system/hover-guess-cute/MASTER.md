...
**Project:** Hover-Guess Cute
**Generated:** 2026-07-30 00:45:02
**Category:** Dating App
...
|------|-----|--------------|
| Primary | `#F472B6` | `--color-primary` |
| Secondary | `#FBCFE8` | `--color-secondary` |
| CTA/Accent | `#22C55E` | `--color-cta` |
| Background | `#FDF2F8` | `--color-background` |
| Text | `#9D174D` | `--color-text` |

**Color Notes:** Soft pink + safe green
